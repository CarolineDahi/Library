        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Modifer = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    GenerationStamp = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillBook_Bills_BillId",
                        column: x => x.BillId,
                        principalTable: "Bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillBook_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDocument", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookDocument_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDocument_Documents_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillBook_BillId",
                table: "BillBook",
                column: "BillId");

            migrationBuilder.CreateIndex(
                name: "IX_BillBook_BookId",
                table: "BillBook",
                column: "BookId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDocument_BookId",
                table: "BookDocument",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookDocument_DocumentId",
                table: "BookDocument",
                column: "DocumentId");
